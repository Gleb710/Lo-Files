...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function( T data)?  success,TResult Function( String errorCode,  String errorMessage)?  failure,required TResult orElse(),}) {final _that = this;
switch (_that) {
case ResultSuccess() when success != null:
return success(_that.data);case ResultFailure() when failure != null:
return failure(_that.errorCode,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function( T data)  success,required TResult Function( String errorCode,  String errorMessage)  failure,}) {final _that = this;
switch (_that) {
case ResultSuccess():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function( T data)?  success,TResult? Function( String errorCode,  String errorMessage)?  failure,}) {final _that = this;
switch (_that) {
case ResultSuccess() when success != null:
return success(_that.data);case ResultFailure() when failure != null:
return failure(_that.errorCode,_that.errorMessage);case _:
...
class ResultFailure<T> extends Result<T> {
  const ResultFailure({required this.errorCode, required this.errorMessage}): super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ResultFailure<T>&&(identical(other.errorCode, errorCode) || other.errorCode == errorCode)&&(identical(other.errorMessage, errorMessage) || other.errorMessage == errorMessage));
}
...
@override
String toString() {
  return 'Result<$T>.failure(errorCode: $errorCode, errorMessage: $errorMessage)';
}
